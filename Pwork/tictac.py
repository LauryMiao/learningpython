...
def inputPlayerLetter():
	#Lets the player type which letter they wanna be
	...
	# the first element in the list is the player's letter, the 2nd for computer
	if letter == 'X':
		return ['X', 'O']
	else:
		return ['O', 'X']
...
def isWinner(bo,le):
	...
	#We use bo instead of board and le instead of letter for convince
